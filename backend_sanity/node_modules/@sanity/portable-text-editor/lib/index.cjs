...
function createPatchToOperations(portableTextFeatures, keyGenerator) {
    ...
    function insertPatch(editor, patch) {
        ...
        if (patch.path.length === 1) {
            ...
            var index = Math.max(0, editor.children.findIndex(function (node, indx) {
...
function createWithPatches(_a) {
    ...
    return [
        function withPatches(editor) {
            ...
            var syncValueAfterIncomingPatches = lodash.debounce(function () { return syncValue(); }, 0, {
                trailing: true,
                leading: false,
            });
...
var PortableTextEditor = /** @class */ (function (_super) {
    ...
    function PortableTextEditor(props) {
        ...
        _this.syncValue = function (userCallbackFn) {
            ...
            var isEqualToValue = _this.slateInstance.children.length === (val || []).length &&
                !(val || []).some(function (blk, index) {
        ...
        _this.selectionRef = React__default["default"].createRef();
        _this.state = {
        ...
        _this.changeSubscription = _this.change$.subscribe(function (next) {
            ...
            switch (next.type) {
                ...
                case 'selection':
                    onChange(next);
                    _this.selectionRef.current = next.selection;
                    break;
                default:
                    onChange(next);
            }
        ...
        _this.state = __assign(__assign({}, _this.state), { initialSlateEditorValue: toSlateValue(getValueOrInitialValue(props.value, [_this.slateInstance.createPlaceholderBlock()]), { portableTextFeatures: _this.portableTextFeatures }, KEY_TO_SLATE_ELEMENT.get(_this.slateInstance)) });
    ...
    PortableTextEditor.prototype.componentDidUpdate = function (prevProps) {
        ...
        var isPristineEditor = !prevProps.value && this.slateInstance.children === this.state.initialSlateEditorValue;
        ...
        return (React__default["default"].createElement(PortableTextEditorContext.Provider, { value: this },
            React__default["default"].createElement(PortableTextEditorValueContext.Provider, { value: this.props.value },
                React__default["default"].createElement(PortableTextEditorReadOnlyContext.Provider, { value: Boolean(this.props.readOnly) },
                    React__default["default"].createElement(PortableTextEditorSelectionContext.Provider, { value: this.selectionRef.current },
                        React__default["default"].createElement(slateReact.Slate, { onChange: NOOP$1, editor: this.slateInstance, value: this.state.initialSlateEditorValue }, this.props.children))))));
    };
    // Static API methods

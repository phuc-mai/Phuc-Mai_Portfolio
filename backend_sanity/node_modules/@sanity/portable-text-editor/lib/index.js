...
function createWithPatches(_a) {
    ...
    return [
        function withPatches(editor) {
            ...
            var syncValueAfterIncomingPatches = debounce(function () { return syncValue(); }, 0, {
                trailing: true,
                leading: false,
            });
        ...
        return (React.createElement(PortableTextEditorContext.Provider, { value: this },
            React.createElement(PortableTextEditorValueContext.Provider, { value: this.props.value },
                React.createElement(PortableTextEditorReadOnlyContext.Provider, { value: Boolean(this.props.readOnly) },
                    React.createElement(PortableTextEditorSelectionContext.Provider, { value: this.selectionRef.current },
                        React.createElement(Slate, { onChange: NOOP$1, editor: this.slateInstance, value: this.state.initialSlateEditorValue }, this.props.children))))));
    };
    // Static API methods

...
function checkoutPair(idPair) {
  ...
  var published = (0, _createBufferedDocument.createBufferedDocument)(publishedId, listenerEvents$.pipe((0, _operators.filter)(isMutationEventForDocId(publishedId))));

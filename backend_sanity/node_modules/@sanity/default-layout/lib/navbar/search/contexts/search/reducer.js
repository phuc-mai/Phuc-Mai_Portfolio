...
function initialSearchState(currentUser, recentSearches) {
  return {
    currentUser,
    debug: (0, _debug.isDebugMode)(),
    filtersVisible: false,
    ordering: _types.ORDER_RELEVANCE,
    pageIndex: 0,
  ...
  switch (action.type) {
    ...
    case 'TERMS_QUERY_SET':
      return _objectSpread(_objectSpread({}, state), {}, {
        ...
        terms: stripRecent(_objectSpread(_objectSpread({}, state.terms), {}, {
          query: action.query
        }))
      });
    case 'TERMS_SET':
...
function stripRecent(terms) {
  if ((0, _isRecentSearchTerms.isRecentSearchTerms)(terms)) {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    var __recent = terms.__recent,
      rest = _objectWithoutProperties(terms, _excluded);
    return rest;
  }
  return terms;
}